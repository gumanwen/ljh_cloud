...
//	GSRX("96", "公司热线","金山用水管理所"),
	...
	GSGX("106", "供水管线周边施工区域","金山路线类型"),
	ZYGS("107", "重要供水节点","金山路线类型"),
	ZYYS("108", "重要用水单位","金山路线类型"),
	GWGD("109", "高危管段","金山路线类型"),
	LLGX("110", "裸露管线","金山路线类型"),
	SBSS("111", "设备设施缺失","金山路线类型"),
	FMDM("112", "阀门堆没","金山路线类型"),
	JSQT("113", "其他","金山路线类型");
